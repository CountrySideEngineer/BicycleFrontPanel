...
#define GET_IMAGE_RESOURCE_PATH(ImageFilePath)                                  \
    ...
    mImageResourcePath[1][2] = GET_IMAGE_RESOURCE_PATH("bicycle_auto_light_on_brake_rear_brake.png");
    mImageResourcePath[1][3] = GET_IMAGE_RESOURCE_PATH("bicycle_auto_light_on_brake_front_rear.png");

    //Setup brake state with light off in manual mode, in other words, light off in request mode.
    mImageResourcePath[3][0] = GET_IMAGE_RESOURCE_PATH("bicycle_manual_light_off.png");
    mImageResourcePath[3][1] = GET_IMAGE_RESOURCE_PATH("bicycle_manual_light_off_brake_front.png");
    mImageResourcePath[3][2] = GET_IMAGE_RESOURCE_PATH("bicycle_manual_light_off_brake_rear.png");
    mImageResourcePath[3][3] = GET_IMAGE_RESOURCE_PATH("bicycle_manual_light_off_brake_rear_front.png");

    //Setup brake state with light on in manual mode, in other words, light on in request mode.
    mImageResourcePath[2][0] = GET_IMAGE_RESOURCE_PATH("bicycle_manual_light_on.png");
    mImageResourcePath[2][1] = GET_IMAGE_RESOURCE_PATH("bicycle_manual_light_on_brake_front.png");
    mImageResourcePath[2][2] = GET_IMAGE_RESOURCE_PATH("bicycle_manual_light_on_brake_rear.png");
    mImageResourcePath[2][3] = GET_IMAGE_RESOURCE_PATH("bicycle_manual_light_on_brake_front_rear.png");
}
